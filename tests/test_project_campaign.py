...
def test_project_decision_campaign():
    ...
    assert out["campaign"] == 'Rehabilitation Episode Review Campaign'
    assert out["campaign_identity"] == 'safety-margin volatility + progression stability frontier'
    assert 'minimum_safety_margin' in out
