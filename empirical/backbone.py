    ...
    try:
        ...
        if suffix=='.zip':
            with zipfile.ZipFile(io.BytesIO(raw)) as z:
                ...
                # Activity archives contain many large raw sensor matrices.
                # Select the largest structured member within a bounded 10 MiB
                # slice so a health/demo call remains responsive while keeping
                # the archive and chosen member in the provenance record.
