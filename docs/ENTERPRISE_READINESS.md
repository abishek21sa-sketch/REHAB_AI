# Enterprise Readiness — REHAB AI

## Release status

**REHAB_AI_PORTFOLIO_RC1** is a portfolio release candidate, not a production deployment certification.

## Decision-system identity

Separates capacity, uncertainty, tail risk and modeled safety-envelope performance with oracle regret instead of claiming universal clinical dominance.

**Signature core:** APACE uncertainty-aware safe dual-control rehabilitation planning + stochastic MPC benchmark

## Verified in this recovery build

- 70/70 Python regression tests verified
...
- `artifacts/portfolio_validation.json` — SHA-256 `5c902dd11105a17bbcdeadd2d5daa9e24adf4471d4f49aa5f8a56549495b413e`

## Gates still required before any production claim

- Windows PowerShell clean-environment acceptance
- External clinical validation and clinician review
- Medical-device/regulatory validation if ever pursued
